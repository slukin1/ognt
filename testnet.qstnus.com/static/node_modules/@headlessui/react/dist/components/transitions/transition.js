...
function He(t, n) {
    ...
    let {
        ...
        leaveTo: d,
        ...i
    } = t, e = c(null), a = ne(e, n), o = (Q = i.unmount) == null || Q ? y.Unmount : y.Hidden, {
        show: f,
        appear: N,
        initial: T
    } = ye(), [l, j] = X(f ? "visible" : "hidden"), z = xe(), {
        register: L,
        unregister: O
    } = z;
    F(() => L(e), [L, e]), F(() => {
...
function Fe(t, n) {
    ...
    let [v, u] = X(r ? "visible" : "hidden"), g = se(() => {
        u("hidden")
    }), [d, i] = X(!0), e = c([r]);
    ge(() => {
