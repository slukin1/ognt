...
class Account {
    ...
    signedDelegate({
        ...
        return __awaiter(this, void 0, void 0, function*() {
            ...
            const {
                header
            } = yield provider.block({
                finality: 'final'
            });
            const {
                accessKey,
                publicKey
            } = yield this.findAccessKey(null, null);
            ...
            } = yield(0, transactions_1.signDelegateAction)({
                delegateAction,
                signer: {
                    sign: (message) => __awaiter(this, void 0, void 0, function*() {
                        const {
                            signature
                        } = yield signer.signMessage(message, delegateAction.senderId, this.connection.networkId);
                        return signature;
                    }),
                }
            });
                ...
                if (state.status === 'fulfilled') {
                    ...
                    if (currentBN !== BigInt(0)) {
                        return Object.assign(Object.assign({}, result), {
                            stakedValidators: [...result.stakedValidators, {
                                validatorId,
