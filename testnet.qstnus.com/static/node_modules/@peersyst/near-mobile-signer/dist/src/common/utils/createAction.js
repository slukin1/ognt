...
const getAccessKey = (permission) => {
    ...
    const allowance = permission.allowance ? new bn_js_1.default(permission.allowance) : undefined;
        ...
        case "FunctionCall":
            {
                ...
                return near_api_js_1.transactions.functionCall(methodName, (0, exports.parseArgs)(args), new bn_js_1.default(gas), new bn_js_1.default(deposit));
            }
        case "Transfer":
            {
                const {
