...
export const isEthUnit = (str) => ['wei', 'kwei', 'mwei', 'gwei', 'szabo', 'finney', 'ether', 'eth'].includes(
    str,
);
...
export const humanToMultiaddrBuffer = (str, {
    strict = true
} = {}) => {
    let multiaddrBuffer;
    try {
...
export const getEventFromLogs = (eventName, logs, {
    strict = true
} = {}) => {
