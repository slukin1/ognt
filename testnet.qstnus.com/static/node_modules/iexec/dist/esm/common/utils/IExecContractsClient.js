...
import {
    version as pocoVersion
} from '../generated/@iexec/poco/package.js';
import {
    networks as iexecProxyNetworks
} from '../generated/@iexec/poco/ERC1538Proxy.js';
...
class IExecContractsClient {
    constructor({
        ...
        const gasPriceOverride =
            useGas === false ? 0 n : getGasPriceOverride(stringChainId);
        ...
        this.setSigner = (ethSigner) => {
            ...
            Object.assign(
                this,
                new IExecContractsClient({ ...this._args,
