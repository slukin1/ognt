...
export const showDataset = async (
    ...
    const {
        obj,
        objAddress
    } = await showObjByAddress(DATASET)(
        contracts,
        await addressSchema({
            ethProvider: contracts.provider
        }).validate(
...
export const showUserDataset = async (
    ...
    const {
        obj,
        objAddress
    } = await showUserObjByIndex(DATASET)(
        contracts,
        await uint256Schema().validate(index),
        await addressSchema({
            ethProvider: contracts.provider
...
export const showWorkerpool = async (
    ...
    const {
        obj,
        objAddress
    } = await showObjByAddress(WORKERPOOL)(
        contracts,
        await addressSchema({
            ethProvider: contracts.provider
        }).validate(
...
export const showUserWorkerpool = async (
    ...
    const {
        obj,
        objAddress
    } = await showUserObjByIndex(WORKERPOOL)(
        contracts,
        await uint256Schema().validate(index),
        await addressSchema({
            ethProvider: contracts.provider
