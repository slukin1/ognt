...
import {
    createObjParams
} from '../execution/order-helper.js';
import {
    checkEventFromLogs,
    bigIntToBn,
    getSalt,
...
import {
    fetchVoucherAddress
} from '../voucher/voucherHub.js';
import {
    hashEIP712
} from '../utils/sig-utils.js';
import {
    NULL_BYTES,
    NULL_BYTES32,
    NULL_ADDRESS,
...
export const matchOrders = async (
    ...
    try {
        ...
        const {
            dealid,
            volume
        } = orderMatchedEvent.args;
        return {
            dealid,
            volume: bigIntToBn(volume),
            txHash: tx.hash
        };
    } catch (error) {
